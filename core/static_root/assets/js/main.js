$(document).ready(function (l) {
    ...
    // searchResult--------------------------------------
    $('.header-right .search-header .search-input').on('click', function () {
        $(this).parents('.search-header').addClass('show-result').find('.search-result').fadeIn();
    ...
    /* ************** favorites product */
    $("button.add-favorites").on("click", function () {
    ...
    $(".mask-handler").click(function (e) {
        e.preventDefault();
        var sumaryBox = $(this).parents('.-summary');
    ...
    $(".-button").click(function (e) {
        e.preventDefault();
        var sumaryBox = $(this).parents('.-article');
        sumaryBox.find('.-article').toggleClass('active');
        sumaryBox.find('.-text').slideToggle();
        $(this).find('.show-more').fadeToggle(0);
        $(this).find('.show-less').fadeToggle(0);
    });
    ...
    // SweetAlert -----------------------------------
    // add-to-cart
    $('.product-actions-secondary .product-introduction-cart').on('click', function (event) {
    ...
    // compare
    $('.product-actions-secondary .comparison').on('click', function (event) {
        event.preventDefault();
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
    ...
    // wishes 
    $('.product-actions-secondary .heart').on('click', function (event) {
        event.preventDefault();
        const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
